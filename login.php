...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['userType'] === 'Admin') {
                        ...
                        header("Location: homepage.php"); // Redirect to Guest homepage
                    } else {
            ...
            $error = "Database query error: " . $mysqli->error;
        }
    }
    ?>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" action="login.php" method="POST">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have an account? <a href="users/register.php">Create an account</a></p>
                                        </div>
                                    </form>
